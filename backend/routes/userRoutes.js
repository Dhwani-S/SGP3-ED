...
router.route("admin/users").getisAuthenticatedUser(authorizeRoles(["admin"]), getAllUser);
router.route("admin/users").getisAuthenticatedUser(authorizeRoles(["admin"]), getSingleUser);
router
  .route("/admin/user/:id")
